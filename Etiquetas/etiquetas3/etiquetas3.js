document.addEventListener('DOMContentLoaded', function() {
    ...
    for (let i = 1; i <= numberOfLabels; i++) {
        const newLabelHtml = `
        <div id="etiquetas">
            <div id="form-${etiquetaCounter}">
                <form id="priceLabelForm"  class="form-container">
        ...
        document.getElementById('etiquetasContainer3').insertAdjacentHTML('beforeend', newLabelHtml);
        etiquetaCounter++;
