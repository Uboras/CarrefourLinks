document.addEventListener('DOMContentLoaded', function() {
    ...
    for (let i = 1; i <= numberOfLabels; i++) {
            ...
            <div id="form-${etiquetaCounter}" class="form-container">
                <form id="priceLabelForm">
                    ...
                    <div class="form-group">
                        ...
                        <button id="btn-quitar-descuento${etiquetaCounter}" onclick="quitarDescuento(${etiquetaCounter})">Quitar descuento</button>
                        <button style="display: none;" id="btn-agregar-descuento${etiquetaCounter}" onclick="agregarDescuento(${etiquetaCounter})">Agregar descuento</button>
                    </div>
                    <div class="form-group">
        ...
        document.getElementById('etiquetasContainer').insertAdjacentHTML('beforeend', newLabelHtml);
        etiquetaCounter++;
